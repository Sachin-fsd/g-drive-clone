    ...
    retryFetch(fetchProfile, { retries: 2 })
      .then(async (res) => {
        ...
        setUserData({
          ...
          email: data.user?.email || "user@skyvault.com",
        ...
        if (t) {
          try {
            ...
            setUserData((prev) => ({
              ...
              email: payload.email || "user@skyvault.com",
  ...
  return (
    <div className="flex items-center justify-between px-6 py-3 bg-white dark:bg-zinc-700 border-b border-gray-200 dark:border-zinc-900">
      ...
      <div className="flex items-center gap-6 flex-1">
        {/* Brand */}
        <div className="flex items-center gap-3" aria-label="SkyVault brand">
         
             <img src="/logo.jpg" alt="SkyVault Logo" className="h-8 rounded-lg" />
          
          <span className="text-xl font-normal text-gray-700 dark:text-zinc-100">SkyVault</span>
        </div>
